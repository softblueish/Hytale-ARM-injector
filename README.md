...
If you do care about the perforance of this game, the [WSL patch does actually work](https://github.com/softblueish/Hytale-ARM-patch/tree/wsl), but it takes a lot of setup. You're better off running the game normally.

## ~~You can download a patch installer here~~
